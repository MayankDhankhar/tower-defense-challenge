...
export class Tile extends EventEmitter {
    ...
    createSprite() {
        ...
        const texture = new PIXI.Texture({source: this.atlas, frame: new PIXI.Rectangle(x + 1, y + 1, App.config.atlas.tileSize - 2, App.config.atlas.tileSize - 2)});
